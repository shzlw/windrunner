...
Email is optional and disabled by default. See [Email notifications](email-notifications)
for SMTP settings, setup instructions, and delivery troubleshooting.
