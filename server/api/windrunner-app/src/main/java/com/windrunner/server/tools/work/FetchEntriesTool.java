...
public class FetchEntriesTool implements Tool<FetchEntriesTool.Parameters> {
    ...
    @Override public String name() { return "fetch_entries"; }
    @Override public String description() { return FileUtils.loadSystemPrompt("fetch-entries-tool.md"); }
    ...
    @Override public Object execute(Parameters parameters) {
        ...
        String workItemId = parameters.workItemId(); int limit = parameters.limit() == null ? 50 : Math.max(1, Math.min(parameters.limit(), 100));
