...
public class FetchManageableUserTool implements Tool<FetchManageableUserTool.Parameters> {
    ...
    public String name() {
        return "fetch_manageable_user";
    }

    public String description() {
        return "Read one exact userId for an admin profile/access proposal, including inactive users. Returns username, email, displayName, title, bio (up to 4000 characters), timezone, status, globalRole. Admin only, respecting managed-user restrictions. No credentials are returned.";
    }
