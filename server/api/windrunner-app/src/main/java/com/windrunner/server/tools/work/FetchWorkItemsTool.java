...
public class FetchWorkItemsTool implements Tool<FetchWorkItemsTool.Parameters> {
    private final WorkItemService workItems; private final ProjectSearchService search;
    @Override public String name() { return "fetch_work_items"; }
    @Override public String description() { return FileUtils.loadSystemPrompt("fetch-work-items-tool.md"); }
