...
public record WorkItemAiReviewResponse(String originalTitle, String proposedTitle, String proposedType, String proposedStatus,
                                       String proposedDueDate, String proposedPriority, List<WorkItemAssignee> proposedAssignees,
