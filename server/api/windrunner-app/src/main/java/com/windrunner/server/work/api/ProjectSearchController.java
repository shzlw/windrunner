...
@RestController @RequiredArgsConstructor @RequestMapping("/internal-api/v1/projects/{projectId}/search")
public class ProjectSearchController {
    private final ProjectSearchService searchService; private final AuthService auth; private final ProjectAccessService access;
    @GetMapping
