...
public class WorkspaceChange {
    ...
    @Column("proposal_id") private String proposalId;
    @Column("project_id") private String projectId;
    @Column("sort_index") private Integer sortIndex;
    @Column("entity_type") private String entityType;
    private String action;
    @Column("target_id") private String targetId;
    private String summary;
    @JsonIgnore @Column("payload_json") private String payloadJson;
    @JsonIgnore @Column("previous_json") private String previousJson;
