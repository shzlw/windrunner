...
public class FindManageableUsersTool implements Tool<FindManageableUsersTool.Parameters> {
    ...
    public record Candidate(String id, String username, String displayName, String email, String status,
                            String globalRole) {
    }
