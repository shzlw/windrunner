...
<usage>
Use this tool when the user asks what a specific team does, who is on it, or which projects it supports. Use a Team id from the conversation context or from `fetch_teams`.
