...
<output_format>
The tool returns one page of member user IDs, names, roles, titles, and bios for the requested Team, plus `total`,
`offset`, `limit`, and `hasMore`. Very long bios are truncated.
</output_format>
